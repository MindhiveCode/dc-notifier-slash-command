...
def save_to_airtable(proposal_data):

    payload = json.dumps({"fields": {"Current Ratio": proposal_data['current_ratio'],
                                     "Yes Count": proposal_data['yes'],
                                     "No Count": proposal_data['no'],
                                     "Abstain Count": proposal_data['abstain']
                                     }
                          }
                         )
